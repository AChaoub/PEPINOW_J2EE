    ...
    <body>
        ...
        <div class="container">
            ...
            <a href="#" class="navbar-brand d-flex align-items-center">
                <img src="IdeaProjects/Exemple/web/WEB-INF/logo.png" width="80px" height="50px">
        ...
        <main>
            <section class="py-5 text-center container">
                <div class="row py-lg-5" style="background-image: url('./images/Pepi1.jpg');background-size: cover;background-repeat: no-repeat;width: 100%;height: auto;">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                        <c:forEach items="${auteurs}" var="titre" varStatus="status">
                            ...
                            <div class="card shadow-sm">
                                <img src="logo.png" width="100%" height="225px" alt="chagement images non valide"/>
                                <div class="card-body">
                                    <p class="card-text"><c:out value="${titre.nom} ${titre.nom}"/> </p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <small class="text-muted">${ titre.actif ? 'Vous êtes très actif !' : 'Vous êtes inactif !' }</small>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="sincrire">
                <div id="logoInscrip">
                    <img src="IdeaProjects/Exemple/web/WEB-INF/logo.png" alt="" width="100" height="auto">
                ...
                <div id="Inscrip">
                    <div id="pan1">
                        ...
                        <input type="text" class="P">
                        <br><br><br>
                        <div ><input id="SeConn" type="button" value="Valider" ></div>
                    </div>
                </div>
            </div>
